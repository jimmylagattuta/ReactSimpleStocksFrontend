...
import { portCheck, fetchStocks, addStocks } from '../actions';
...
class Port extends Component {
	...
	componentWillMount() {
		...
		const { portCheck, fetchStocks, addStocks } = this.props;
...
const mapStateToProps = (state) => {
	const { portCheck, fetchStocks, addStocks } = state;
	return { portCheck, fetchStocks, addStocks };
}

export default connect(mapStateToProps, { portCheck, fetchStocks, addStocks })(Port);