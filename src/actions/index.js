...
export const getStocks = (portId) => {
	// console.log('portId for get stocks', portId);
	const request = axios.post('http://localhost:3000/api/v1/port_stocks/get_stocks', { data: portId });
	return {
		type: GET_STOCKS,
		payload: request
	};
